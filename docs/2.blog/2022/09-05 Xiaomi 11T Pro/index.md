...
![](bt.webp "開発者向けオプションのBluetoothコーデックの内容（他端末では必ずしも全てがスマートフォン側で利用できるわけではないので要注意）")
...
![](sizes.webp "Rakuten Hand 5Gと本体・充電器を比較")
...
## カメラ（静止画）
![](photo-mi11tpro.webp "細い線が多いので好ましい作例ではない")
...
![](sos.webp "緊急SOSの使用はオフにしたほうが無難でしょう")
...
![](unlock-boo.webp "MotorolaならすぐUnlockさせてくれるのに……")
