...
![](lp01_arnd.webp "darktableでdngを開くと、歪みは確認できないが周辺減光がすごい")
...
![](thumbnail.webp "GX7MK2 + 20mm/F1.7で比較　9mm/F1.7はこれよりもう少し厚い")
...
![](lp01_hdr_l-false.webp "HDR有効 明るさ強調無効")

![](lp01_hdr_l-true.webp "HDR有効 明るさ強調有効")

![](lp01_manual.webp "HDR無効（マニュアル・数値は自動か初期値・RAW記録有効）")

![](lp01_leitz.webp "LEITZ LOOKS　HDR設定によって撮影結果は変化する")
...
[下の画像のRAW画像はこちら（DSC_0069.dng 38.6MB）](https://github.com/tamaina/tamaina.github.io/raw/main/docs/2.blog/2022/10-04%20Leitz%20Phone%201%202/DSC_0069.dng)

JPEGのEXIFにはISO-2486と記録されているのにRAWはISO-1125となっているのはどうしてなんでしょうね？

![](DSC_0069.webp "1.4倍 JPEG撮って出し")

![](DSC_0069_RAW.webp "darktableでノイズ除去をする")

![](DSC_0069-a.webp "ザラザラ感はあるが明瞭になった……気がする")

ところで、RAW画像の左下を拡大するとこのようにノイズが白い点になって見えるのですが……

![](noises.webp "あり得ないところに白い点がある")
...
![](gx7mk2-0069.webp "LUMIX GX7MK2 + LUMIX G 20mm/F1.7, ISO-1250")
...
![](4k_burst.webp "まずはAIライブシャッターによって撮影された0.7倍フルの画角")

![](4k60p_stab_1x.webp "4K60p 1倍 手振れ補正あり")

![](4k60p_stab_0.7x.webp "4K60p 0.7倍 手振れ補正あり（Xiaomi 11T Proの手振れ補正あり1倍と同等程度）")

![](4k60p_nostab_1x.webp "4K60p 1倍 手振れ補正なし")

![](4k60p_nostab_0.7x.webp "4K60p 0.7倍 手振れ補正なし")

![](4k30p_stab_1x.webp "4K30p 1倍 手振れ補正あり")

![](4k30p_stab_0.7x.webp "4K30p 0.7倍 手振れ補正あり")

![](4k30p_nostab_1x.webp "4K30p 1倍 手振れ補正なし")

![](4k30p_nostab_0.7x.webp "4K30p 0.7倍 手振れ補正なし")
