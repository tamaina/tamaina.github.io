...
![](1yen.webp "レシート　無制限プランもしくはスマホデビュープランへのMNP限定とかだった気がする")
...
![](eq.webp "Apple Musicでイコライザを開こうとしたところ、Xperiaのオーディオ設定が出てきた")
...
![](antutu.webp "Xperia 10 IV AnTuTuベンチマーク結果")
