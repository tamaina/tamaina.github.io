...
![](back.avif "背面全体。写真の露出を落としてある")

![](thumbnail.avif "肉眼に近い明るさ")
...
![](tpu_side.avif "TPUケース側面。さらさらしている。")
...
![](display.avif "ディスプレイ。モトローラの安い端末よりはベゼルが狭い。")
...
### 静止画
![](16mp.avif "メイン広角 16MP")

![](48mp.avif "メイン広角 48MP")

![](2x16mp.avif "カメラアプリの焦点距離を「2.0x」に設定 16MP")
...
![](gpay.avif "Google Payでクレカタッチを利用できる(画像はRevolut)")
...
![](nfcbug.avif "Xiaomi 11T Proと重ねると「収集された新しいタグ」画面が出る")
...
![](antutu.avif "TONE e22 AnTuTuベンチマーク結果")
