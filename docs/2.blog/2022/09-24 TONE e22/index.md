...
![](tpu_side.webp "TPUケース側面。さらさらしている。")
...
![](display.webp "ディスプレイ。モトローラの安い端末よりはベゼルが狭い。")
...
![](2x16mp.webp "カメラアプリの焦点距離を「2.0x」に設定 16MP")
...
![](gpay.webp "Google Payでクレカタッチを利用できる(画像はRevolut)")
...
![](antutu.webp "TONE e22 AnTuTuベンチマーク結果")
