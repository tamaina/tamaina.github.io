...
AOKZOE A1Proを開封し、外観を見ていきます。コントローラーなどハードウェアに関する感想や、キーボードのないハードを便利に使うための説明もあります。
...
![](open5.webp "開けるとまず追加購入したガラスプロテクタが入っていました")

画面保護フィルムはあらかじめ貼ってあります。  
画面保護フィルムは光沢があり余白が全くないため、貼ってあることがわかりません。

追加で購入したガラスプロテクタも余白が全くありません。  
私は余白のないガラスプロテクタを貼るテクニックをまだ習得していないため、何もいじらずフィルムで運用することにしました。
...
65W充電器(FC139C)ですが、ロック穴とPSEマークがないため使用は控えます。  
ただしApple 68W充電器をMacBook Proと共用することになったため充電事情がピンチです。65W充電器を調達するべきなんですがなかなか踏ん切りがつかず……

当然ですが、ハイビームではPSEに適合したものが販売されるだろうと思われます。
...
- 良かったのは、[液晶ディスプレイ](#画面)・[ジョイスティック・ABXY](#コントローラーの感触)・[付属ソフト](#onexconsole)と[ファンクションキー](#ファンクションキー)
- 悪かったのは、[Dpad・RTLT](#コントローラーの感触)・[スピーカー](#スピーカー音質)
- 注意すべきは、画面保護フィルム・[充電器](#充電器)・[キーボード](#画面内キーボード)
