...
HIGH-BEAMの32GBが1万円OFFの先々行販売が6/26正午までなので、取り急ぎCPU-Zなどのハードウェアの情報や、今までのベンチマークやゲーム動作の感想を掲載します。
...
## 7. ゲームベンチマーク
ゲームのベンチマークも色々回したかったのですが、ここをやっている途中で時間切れになりました。  
（実際問題として私はあんまりゲームを持っていないため皆様の期待したタイトルが出てこないと思いますが…）

SteamのIDを貼っておきますね。  
https://steamcommunity.com/id/tamaina/

![](3.webp "BLUE PROTOCOL, FFベンチをちょっとやった")
